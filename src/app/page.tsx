...
const AdsterraGlobalBannerBottom = () => {
  return (
    <div style={{ width: '100%', display: 'flex', justifyContent: 'center', background: 'rgba(0,0,0,0.3)', borderTop: '1px solid var(--border-color)', padding: '16px 0', marginTop: 'auto' }}>
      <iframe src="/ad300.html" width="300" height="250" frameBorder="0" scrolling="no" style={{ maxWidth: '100%', overflow: 'hidden' }}></iframe>
    </div>
  );
};
